...
export const JSON_RPC_URL =
  "https://astar.blastapi.io/5d08b0bf-97fc-4387-968c-548c2ae8cea8";
...
export const MASTER_CHEF_POOLS = [
  {
    name: "ORU/USDC",
    address: "0x0D02dFE1E662FbB70255D61b85ABE267D0179ee8",
    mobileToken0Icon: <ORUIcon ratio={"5vw"} />,
    token0Icon: <ORUIcon ratio={"1.192vw"} />,
    mobileToken1Icon: <USDCIcon ratio={"5vw"} />,
    token1Icon: <USDCIcon ratio={"1.192vw"} />,
    token0: "ORU",
    token1: "USDC",
  },
  {
    name: "oUSD/USDC",
    address: "0x8C6d6Ec1B320f38D4cd58Cac30562A35DA0F1EE6",
    mobileToken0Icon: <OUSDIcon ratio={"5vw"} />,
    token0Icon: <OUSDIcon ratio={"1.192vw"} />,
    mobileToken1Icon: <USDCIcon ratio={"5vw"} />,
    token1Icon: <USDCIcon ratio={"1.192vw"} />,
    token0: "OUSD",
    token1: "USDC",
  ...
  {
    name: "oUSD/ORU",
    address: "0x318d0540aec0709dDDD67480eFAC0EeF217Dfcf0",
    mobileToken0Icon: <OUSDIcon ratio={"5vw"} />,
    token0Icon: <OUSDIcon ratio={"1.192vw"} />,
    mobileToken1Icon: <ORUIcon ratio={"5vw"} />,
    token1Icon: <ORUIcon ratio={"1.192vw"} />,
    token0: "OUSD",
    token1: "ORU",
  },
];
...
export const VAULTS = [
  {
    ...
    addLpLink:
      "https://pandoraswapxyz.org/add/0x8ea356004327E598729b4CE590eDC90428Dc6A89/0xAeaaf0e2c81Af264101B9129C00F4440cCF0F720",
    ...
    platform: {
      ...
      description:
        "Pandora Swap is a One-Stop DeFi Hub with the most complete ecosystem within Astar Network focused on offering an accessible, transparent and secure experience for everyone.",
    ...
    token0: {
      ...
      description:
        "PANDORA is the native token with an outstanding utility to empowers the whole Pandora Swap ecosystem.",
      website: "https://pandoraswapxyz.org/",
      logo: (
        <img src={pandora} style={{ width: "2.344vw", height: "2.344vw" }} />
      ),
      mobileLogo: (
        <img src={pandora} style={{ width: "5.344vw", height: "5.344vw" }} />
      ),
    },
    token1: {
      name: "WASTR",
      ...
      mobileLogo: (
        <img src={wastr} style={{ width: "5.344vw", height: "5.344vw" }} />
      ),
    },
  },
  {
  ...
  },
  {
    ...
    addLpLink:
      "https://pandoraswapxyz.org/add/0x6a2d262D56735DbA19Dd70682B39F6bE9a931D98/ASTR",
    buyLink: "https://pandoraswapxyz.org/swap",
    mainTokenPair: TOKEN_VAULT_LP_ADDRESSES.PANDORA_USDC,
    routerAddress: VAULT_ADDRESSES.ROUTER,
  ...
  },
  {
    ...
    token0: {
      ...
      mobileLogo: (
        <img src={usdt} style={{ width: "5.344vw", height: "5.344vw" }} />
      ),
    },
    token1: {
      name: "USDC",
  ...
  },
  {
    ...
    addLpLink:
      "https://pandoraswapxyz.org/add/0x6a2d262D56735DbA19Dd70682B39F6bE9a931D98/0x6De33698e9e9b787e09d3Bd7771ef63557E148bb",
    buyLink: "https://pandoraswapxyz.org/swap",
    mainTokenPair: TOKEN_VAULT_LP_ADDRESSES.PANDORA_USDC,
    routerAddress: VAULT_ADDRESSES.ROUTER,
    ...
    token1: {
      ...
      mobileLogo: (
        <img src={dai} style={{ width: "5.344vw", height: "5.344vw" }} />
      ),
    },
  },
];
