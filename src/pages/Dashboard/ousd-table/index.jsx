      ...
      await window.ethereum.request({
        ...
        params: {
          ...
          options: {
            ...
            image:
              "https://drive.google.com/file/d/1KC1FgK-8gpfEjnzDvxAAzQO3FJ5N2Vyo/view?usp=sharing", // A string url of the token logo
          },
        },
      });
    } catch (error) {
  ...
  return (
    <OUSDTableWrapper>
      <HDiv>
        {!isMobileScreen() ? (
          <VDiv
            style={{
              ...
              alignItems: isMobileScreen() ? "center" : "",
            }}
          >
            <UnwrappedOUSDIcon
              ratio={isMobileScreen() ? "5.344vw" : undefined}
            />
        ...
        <TokenPrice>
          ${ousdInfo ? formattedNum(ousdInfo.ousdPrice) : 0}
        </TokenPrice>
      </HDiv>
