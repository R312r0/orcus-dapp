...
const Farms = () => {
  ...
  const init = async () => {
    ...
    const relativeWeight = await GAGUE_CONTROLLER.gaugeRelativeWeight(
      "0x5FF4735274b0C7ADf7de52768645aA08AE4bcB20",
      1651104000
    );
    const farmTvl = await SRS_LP_TOKEN.balanceOf(
      "0x5FF4735274b0C7ADf7de52768645aA08AE4bcB20"
    );
    const rewardTokenPerSecondSRS = await GAGUE_OUSD.rewardData(
      "0x9448610696659de8F72e1831d392214aE1ca4838"
    );
    const rewardTokenPerSecondORU = await GAGUE_OUSD.rewardData(
      CONTRACT_ADDRESSES.ORU
    );

    const baseApr =
      ((+srsRate / 1e18) * 86400 * 365 * 0.1 * (+relativeWeight / 1e18) * 100) /
      (farmTvl / 1e18);
    const extraSrs =
      (rewardTokenPerSecondSRS.rate * 86400 * 365 * 0.1 * 100) / farmTvl;
    const extraOru =
      (rewardTokenPerSecondORU.rate * 86400 * 365 * liquidity.oruPrice * 100) /
      farmTvl;
    ...
    setMasterChefPools([
      {
        name: "ORU/USDC",
        addURL:
          "https://app.arthswap.org/#/add/0xCdB32eEd99AA19D39e5d6EC45ba74dC4afeC549F/0x6a2d262D56735DbA19Dd70682B39F6bE9a931D98",
        removeURL:
          "https://app.arthswap.org/#/remove/0x6a2d262D56735DbA19Dd70682B39F6bE9a931D98/0xCdB32eEd99AA19D39e5d6EC45ba74dC4afeC549F",
        lpToken: ORU_USDC,
        liquidity: liquidity.oruUsdcLiq,
      ...
      },
      {
        name: "oUSD/USDC",
        addURL:
          "https://app.arthswap.org/#/add/0x29F6e49c6E3397C3A84F715885F9F233A441165C/0x6a2d262D56735DbA19Dd70682B39F6bE9a931D98",
        removeURL:
          "https://app.arthswap.org/#/remove/0x29F6e49c6E3397C3A84F715885F9F233A441165C/0x6a2d262D56735DbA19Dd70682B39F6bE9a931D98",
        lpToken: OUSD_USDC,
        liquidity: liquidity.ousdUsdcLiq,
        token0Icon: <OUSDIcon />,
        token1Icon: <USDCIcon />,
      },
      {
        name: "oUSD/ORU",
        addURL:
          "https://app.arthswap.org/#/add/0x29F6e49c6E3397C3A84F715885F9F233A441165C/0xCdB32eEd99AA19D39e5d6EC45ba74dC4afeC549F",
        removeURL:
          "https://app.arthswap.org/#/remove/0x29F6e49c6E3397C3A84F715885F9F233A441165C/0xCdB32eEd99AA19D39e5d6EC45ba74dC4afeC549F",
        lpToken: OUSD_ORU,
        liquidity: liquidity.oruOusdLiq,
        token0Icon: <OUSDIcon />,
  ...
  const claimWithPenalty = async (vid) => {
    ...
    try {
      const tx = await MASTER_CHEF.connect(signer).claimWithPenalty(
        poolId,
        vid
      );
      await tx.wait();
              ...
              >
                ...
                >
                  ...
                  <div style={{ flexDirection: "column" }}>
                    <OverlayText>
                      {MASTER_CHEF_POOLS[poolId].token0}
                    </OverlayText>
                ...
                >
                  ...
                  <div style={{ flexDirection: "column" }}>
                    <OverlayText>
                      {MASTER_CHEF_POOLS[poolId].token1}
                    </OverlayText>
              ...
              <ClaimsContainer>
                {userRewards && userRewards[poolId].vestings.length > 0 ? (
                  <>
                    {userRewards[poolId]?.vestings.map((item, _ind) => {
                      ...
                      const endTime = new Date(
                        (+item.startTime + 604800 * (4 - 1)) * 1000
                      );
                            ...
                            <ClaimsRow>
                              ...
                              >
                                <OverlayClaim
                                  ...
                                  onClick={() => claimReward(_ind)}
                                >
                                  <BriefcaseIcon></BriefcaseIcon>Claim
                                </OverlayClaim>
                                <OverlayOutline
                                  disabled={
                                    currentTime.getTime() > endTime.getTime()
                                  }
                                  onClick={() => claimWithPenalty(_ind)}
                                >
                                  <CrosshairsIcon></CrosshairsIcon>Claim with
                                  Penalty
                                </OverlayOutline>
                              </div>
                            </ClaimsRow>
                  ...
                  <h3 style={{ marginLeft: "1vw" }}>
                    {" "}
                    You have no vestings on this pool!{" "}
                  </h3>
                )}
              </ClaimsContainer>
            </FarmsOverlayContent>
        ...
        {!(isRewardsOverlay && isMobileScreen()) ? (
          <>
                        ...
                        return (
                          <RewardsBlock>
                            <RewardsBlockContent>
                              ...
                              <ManageButton onClick={() => openOverlay(_ind)}>
                                Manage
                              </ManageButton>
                            </RewardsBlockContent>
                          </RewardsBlock>
            ...
            <Scroll>
              ...
              <VDiv>
                <HeadingText style={{ marginTop: "2.24vw", display: "none" }}>
                  Orcus Metapool
                </HeadingText>
              </VDiv>
              <FarmsTableWrapper>
                    ...
                    <FarmsRow>
                      <FarmsColumn>
                        <div style={{ display: "flex", marginRight: "0.98vw" }}>
                          ...
                          <div
                            style={{
                              marginLeft: isMobileScreen() ? "-2.1vw" : "-1vw",
                            }}
                          >
                            <USDTIcon
                              ratio={isMobileScreen() ? "5vw" : undefined}
                        ...
                        <VDiv ml="2.481vw">
                          <Text
                            fontSize={isMobileScreen() ? "16px" : undefined}
                          >
                            <b
                              style={{
                          ...
                          >
                            ...
                            <Text
                              ...
                              fontSize={isMobileScreen() ? "12px" : "0.729vw"}
                              lineHeight="1.094vw"
                              ml="0.313vw"
                            >
                              Sirius Finance
                        ...
                        >
                          ...
                          <Text fontSize="16px">
                            <b style={{ fontWeight: "400" }}>
                              ${metaPool ? formattedNum(metaPool.tvl) : 0}
                            </b>
                          </Text>
                        </FarmsColumn>
                      )}
                      {!isMobileScreen() ? (
                        <FarmsColumn center>
                          ...
                          <Text ml="0.885vw">
                            <b>
                              {" "}
                              {metaPool ? formattedNum(metaPool.metaApr) : 0}%
                            </b>
                          </Text>
                        </FarmsColumn>
                      ) : (
                      ...
                      {!isMobileScreen() ? (
                        <FarmsColumn center>
                          <AddLiquidityBtn
                            target={"_blank"}
                            href={
                              "https://app.sirius.finance/#/pools/ousd/deposit"
                            }
                          >
                            Add Liquidity<ArrowTopRightIcon></ArrowTopRightIcon>
                          </AddLiquidityBtn>
                        </FarmsColumn>
                      ) : (
                        <FarmsColumn center>
          ...
          <>
            <FarmsOverlayContent>
              ...
              <RewardsHead style={{ marginTop: "16px" }}>
                ...
                <div
                  style={{ display: "block", paddingLeft: "0.8vw", gap: "8px" }}
                >
                  <Text>Vested Rewards</Text>
                  <br />
                  <OverlayValue> {formattedNum(vestedAmt)} ORU</OverlayValue>
              ...
              <HDivider
                style={{ marginTop: isMobileScreen() ? "16px" : "0.8vw" }}
              ></HDivider>
              <ClaimsHead>
                <div>Time left</div>
                <div>Amount</div>
                          ...
                          {amt > 0 ? (
                            <ClaimsRow>
                              ...
                              <OverlayClaim
                                ...
                                onClick={() => claimReward(_ind)}
                              >
                                <BriefcaseIcon ratio="3vw"></BriefcaseIcon>Claim
                              </OverlayClaim>
                              <OverlayOutline
                                disabled={
                                  currentTime.getTime() > endTime.getTime()
                                ...
                                onClick={() => claimWithPenalty(_ind)}
                              >
                                <CrosshairsIcon ratio="3vw"></CrosshairsIcon>
                                Claim with Penalty
                              </OverlayOutline>
                            </ClaimsRow>
                          ) : null}
