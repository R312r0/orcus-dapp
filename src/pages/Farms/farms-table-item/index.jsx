  ...
  return (
    <FarmsTableItem isExpanded={expanded}>
      <MainData>
        <FarmsRow>
          <FarmsColumn>
            <IconWrapper>{item.token0Icon}</IconWrapper>
            <IconWrapper>{item.token1Icon}</IconWrapper>
            <VDiv ml="0.781vw">
              <Text>
                <b>{item.name}</b>
              </Text>
            ...
            <VDiv w="33.021vw" ml="10.260vw">
              ...
              >
                ...
                <HelpCircleContainer>
                  <HelpCircleIcon />
                  <HelpText>
                    To start vesting rewards please click on Start Vesting at
                    first, then you will be eligible to claim
                    <br />
                    <br />
